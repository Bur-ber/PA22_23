...
<?php
	$connect = connectDB();
	$query = $connect -> query("SELECT * FROM " .PRE_DB."EVENT WHERE start_date <=CURDATE() ORDER BY id ASC");
...
<table class="table">
	...
	<tbody>
        ...
        <form method="POST" action="adminPanelArchives.php?event=<?php echo $event["id"]?>">
		<td>
